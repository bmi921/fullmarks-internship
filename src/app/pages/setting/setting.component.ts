...
export class SettingComponent implements OnInit {
  ...
  selectAll(): void {
    this.prefectures.forEach(prefecture => this.selectedPrefectures.add(prefecture));
    this.savePrefecturesToLocalStorage();
  }
  ...
  private savePrefecturesToLocalStorage(): void {
    localStorage.setItem(this.localStorageKey, JSON.stringify(Array.from(this.selectedPrefectures)));
  }
